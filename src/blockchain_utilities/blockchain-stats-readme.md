# Haven Blockchain Stats

Haven Blockchain Stats utlity exports daily statistics for the haven blockchain from creation through current state.

## Usage:

See also the utility's help option. `haven-blockchain-stats --help`
...
- `haven-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `haven-blockchain-stats | save-to-database.sh`
